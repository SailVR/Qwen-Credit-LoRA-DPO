...
train_dataset_path = "train_format.json"
eval_dataset_path = "eval_format.json"
train_process_path = "./processed_finance_train_dataset"
eval_process_path = "./processed_finance_eval_dataset"
...
def main():
    ...
    args = TrainingArguments(
        output_dir="./output_lora/Qwen3-0.6B",
    ...
    trainer.save_model("./output_lora/final_model")
    print("Model saved to: ./output_lora/final_model")
